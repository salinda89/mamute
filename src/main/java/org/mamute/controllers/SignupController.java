...
public class SignupController {
  ...
  @Post
  public void signup(String email, String password, SanitizedText name,
    ...
    result.include("mamuteMessages",
        asList(messageFactory.build("confirmation", "signup.confirmation")));
  ...
  private void checkSignup() {
    if (!env.supports("feature.signup")) {
      throw new IllegalStateException(
          "Signup is disabled in your configuration, use 'feature.signup' " +
