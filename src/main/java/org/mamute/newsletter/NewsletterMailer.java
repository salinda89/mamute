...
public class NewsletterMailer extends AWSSimpleMailer {
  ...
  public void sendTo(ScrollableResults results, boolean isTestNewsletter) {
    ...
    LinkToHelper linkToHelper = new LinkToHelper(router, brutalEnv);
    String siteName = bundle.getMessage("site.name");
    String date = brutalDateFormat.getInstance("date.joda.newsletter.pattern")
        .print(new DateTime());
